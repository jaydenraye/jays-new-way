...
const LESSON_QUESTIONS = {
  ...
  1: [
    ...
    { q: 'Why does events-based relief not last?', options: ['Because problems always come back', 'Because people do not try hard enough', 'Because the underlying beliefs are still running after the event improves', 'Because life is unpredictable'], correct: 2, explanation: 'When the event improves the person feels temporarily better — but the same beliefs are still running. The relief is short-lived.' },
  ...
  2: [
    ...
    { q: 'Why do people hold incorrect beliefs?', options: ['Because they are lazy or weak', 'Because they choose not to think clearly', 'Because the data they received was insufficient to form an accurate belief', 'Because of mental illness'], correct: 2, explanation: 'Beliefs that lack sufficient data to make them accurate will be inaccurate — but the person will not experience them as inaccurate.' },
  ...
  5: [
    { q: 'What does free will as commonly understood claim?', options: ['That people are governed by their beliefs', 'That people have pure choice — their minds are not governed by anything', 'That people are controlled by emotions', 'That behaviour is determined by genetics'], correct: 1, explanation: 'Free will declares that people have pure choice and their minds are not governed by anything. But this contradicts itself when examined closely.' },
  ...
  7: [
    { q: 'What is a person value accurately understood?', options: ['Their value to their own success', 'The role they play in other people development', 'Their achievements and contributions', 'Their potential'], correct: 1, explanation: 'A person value is never their value to their own development. It is the role they play in other people development — the data they contribute to the system of life.' },
    { q: 'Is a person worth affected by whether they believe they are worthy?', options: ['Yes — if you do not believe in your worth it diminishes', 'Yes — worth depends on self-belief', 'No — worth is structural and exists regardless of what anyone believes', 'It depends on the person'], correct: 2, explanation: 'A person is valuable regardless of whether they believe they are valuable. The belief and the fact are two separate things.' },
  ...
  8: [
    ...
    { q: 'What does the accurate understanding do that prevents suicidal thinking?', options: ['It provides hope for the future', 'It replaces the belief that value is attached to outcomes with the accurate account that worth is unconditional', 'It teaches coping strategies', 'It improves circumstances'], correct: 1, explanation: 'Every person who understands that their value is the automatic role they play in the system of life survives situations that would otherwise produce suicidal thinking.' },
  ],
  9: [
