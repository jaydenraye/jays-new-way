...
const LEARN_CONTENT = [
  {
    ...
    questions: [{"q": "What is society"s foundation philosophy as described in this lesson?", "options": ["Work hard and you will succeed", "If you are good — you"ll get", "Be kind to others", "Focus on your goals"], "correct": 1, "explanation": "The exact phrase is: "If you are good — you"ll get." This is the specific language installed in people by parents, schools, religion, and culture."}, {"q": "What does the "If you are good — you"ll get" philosophy declare is possible?", "options": ["Success and achievement", "Missing out on necessities", "Happiness and fulfilment", "Control over life"], "correct": 1, "explanation": "The philosophy declares the possibility of MISSING OUT — that if you are not good enough, you will miss out on what you need."}, {"q": "What sits at the base of every form of psychological stress?", "options": ["Fear of failure", "Fear of missing out", "Fear of rejection", "Fear of change"], "correct": 1, "explanation": "At the base of all psychological stress you always find the FEAR OF MISSING OUT on what is needed for development and survival."}, {"q": "What must a person prove before they can receive, according to this philosophy?", "options": ["Their intelligence", "Their loyalty", "Their worthiness", "Their capability"], "correct": 2, "explanation": "The philosophy requires people to show they are WORTHY of receiving — that they are a worthwhile investment who deserves to receive their necessities."}, {"q": "How deeply embedded is this philosophy in most people?", "options": ["Most people are aware of it", "Only some people are affected by it", "It is so deeply embedded that most people are unaware it exists", "It only affects people with mental health conditions"], "correct": 2, "explanation": "This philosophy is so deeply embedded that most people are living by it without ever being consciously aware of it. It governs how they interpret every event, relationship, and outcome."}]
  },
  {
    ...
    questions: [{"q": "What are the two opinions on what causes psychological stress?", "options": ["Genetics vs environment", "Events vs thoughts (beliefs)", "Past trauma vs current circumstances", "Personality vs situation"], "correct": 1, "explanation": "There are two opinions: (1) stress is caused by poor decisions about which events to have, and (2) stress is caused by particular thoughts and beliefs about events."}, {"q": "What does events-based help actually reinforce?", "options": ["Healthy coping strategies", "The beliefs already causing the stress", "Positive thinking patterns", "Better decision making"], "correct": 1, "explanation": "Events-based help reinforces the precise beliefs responsible for the stress — the belief that life is going wrong, that the person needs to prove control, and that their value is at risk."}, {"q": "Why does events-based relief not last?", "options": ["Because the problems always come back", "Because people don"t try hard enough", "Because the underlying beliefs are still running after the event improves", "Because life is unpredictable"], "correct": 2, "explanation": "When the event improves, the person feels temporarily better — but then life continues to unfold the way life does, and the same beliefs are still running. The relief is short-lived."}, {"q": "What is the actual cause of psychological stress according to this lesson?", "options": ["Difficult life circumstances", "Specific incorrect beliefs about events", "Poor decision-making", "Lack of support"], "correct": 1, "explanation": "It is specific incorrect beliefs — not events — that produce all psychological stress. The cause is addressed by gaining a greater understanding of the events encountered."}]
  },
  {
    ...
    questions: [{"q": "What is a belief?", "options": ["A choice about how to think", "An opinion that can change easily", "An understanding a person holds, constructed from data", "A habit of thought"], "correct": 2, "explanation": "A belief is an understanding a person holds. This understanding consists of data that has enabled its construction — and it is the logical construction of that data that makes the person consider it accurate."}, {"q": "Why do people hold incorrect beliefs?", "options": ["Because they are lazy or weak", "Because they choose not to think clearly", "Because the data they received was insufficient to form an accurate belief", "Because of mental illness"], "correct": 2, "explanation": "Beliefs that lack sufficient data to make them accurate will be inaccurate. But the person holding them will not experience them as inaccurate — they will experience them as simply how things are."}, {"q": "Why might someone act contrary to their stated values?", "options": ["Because they are hypocritical", "Because a different, higher-priority belief governed the action instead", "Because they lack willpower", "Because they didn"t think carefully"], "correct": 1, "explanation": "Every person has a belief system in a priority format. When a person acts contrary to stated values, it is because a different belief held a higher priority at that moment. This is not self-sabotage."}, {"q": "How do beliefs change?", "options": ["By deciding to think differently", "By willpower and effort", "When new data provides sufficient reasoning to alter the existing understanding", "By therapy and counselling"], "correct": 2, "explanation": "Beliefs are not chosen — they are formed from incoming data. They cannot be changed by deciding to change them. They change when new data provides sufficient reasoning to alter the existing understanding."}]
  },
  {
    ...
    questions: [{"q": "What does the Achievement Model connect personal development to?", "options": ["Wisdom and understanding", "Personal control over how life unfolds", "Helping other people", "Spiritual growth"], "correct": 1, "explanation": "The Achievement Model connects personal development to personal control over how life unfolds — declaring that value and development are proven by achieving goals and demonstrating capability."}, {"q": "What is the "achievement box"?", "options": ["A goal-setting tool", "The particular existence a person believes must be achieved for life to be a success", "A reward for good behaviour", "A type of journalling exercise"], "correct": 1, "explanation": "The achievement box is the particular existence a person believes must be achieved for their life to be considered a success — representing the way life must go before they will consider themselves valuable."}, {"q": "Under the Achievement Model, what does a poor result threaten?", "options": ["Future opportunities", "Personal worth", "Relationships", "Career prospects"], "correct": 1, "explanation": "Under the Achievement Model, a good result confirms worth and a poor result threatens it. Worth is constantly being measured by outcomes and performance."}, {"q": "What is the Achievement Model a direct result of?", "options": ["Modern workplace culture", "The "If you are good — you"ll get" foundation philosophy", "Scientific research on motivation", "Social media influence"], "correct": 1, "explanation": "The Achievement Model is the direct result of the "If you are good — you"ll get" philosophy. It has people measuring their value by their ability to display control over how life unfolds."}]
  },
  {
    ...
    questions: [{"q": "What does the Wisdom Model measure personal development by?", "options": ["Achievements and outcomes", "Level of understanding of what is actually taking place in life", "Control over circumstances", "Approval from others"], "correct": 1, "explanation": "The Wisdom Model measures development by growth in understanding of reality — wisdom. It has nothing to do with control over life."}, {"q": "What does "we grow from our life experiences" actually mean?", "options": ["We become stronger through suffering", "We develop ourselves through effort", "We grow from our environment — life develops us", "We learn from our mistakes"], "correct": 2, "explanation": "A life experience is incoming data from the environment. "We grow from our experiences" actually means we grow from our environment. Life develops us — not the other way around."}, {"q": "Under the Wisdom Model, what is the purpose of goals?", "options": ["To prove worth when achieved", "To produce active interaction with the environment that generates development", "To measure progress", "To impress others"], "correct": 1, "explanation": "Goals produce active interaction with the environment, resulting in life experiences that provide development. The goal is not the point — the development encountered on the way is the point."}, {"q": "Under the Wisdom Model, what happens to psychological pressure?", "options": ["It is managed more effectively", "It is reduced because worth is no longer attached to outcomes", "It disappears entirely", "It is redirected into productivity"], "correct": 1, "explanation": "The Wisdom Model removes the pressure of having worth attached to outcomes. Every experience provides development — not just the ones that go as desired — so no experience is a threat to worth."}]
  },
  {
    ...
    questions: [{"q": "What does free will, as commonly understood, claim?", "options": ["That people are governed by their beliefs", "That people"s minds are not governed by anything — that they have pure choice", "That people are controlled by their emotions", "That behaviour is determined by genetics"], "correct": 1, "explanation": "Free will declares that people"s minds are not being governed by anything — that they have pure choice. But this contradicts itself when examined closely."}, {"q": "What is the contradiction at the heart of the free will concept?", "options": ["It is used to judge people unfairly", "It says people are ungoverned yet should have acted correctly — which implies being governed by reasons", "It ignores emotion", "It is too philosophical to be practical"], "correct": 1, "explanation": "Free will simultaneously declares people are not governed while insisting they should have acted more correctly — which implies being governed by reasons. It contradicts itself."}, {"q": "What governs every person"s actions at every moment?", "options": ["Their emotions", "Random chance", "The beliefs and priorities they hold at that specific moment in their development", "Their conscious decisions"], "correct": 2, "explanation": "Every person at every moment acts from the beliefs and priorities they hold at that specific moment in their development. Given those beliefs, they could not have acted differently."}, {"q": "What does understanding that free will doesn"t exist do to anger and guilt?", "options": ["It makes them worse", "It means we must accept all behaviour", "It removes their logical foundation — they require the false premise that someone could have chosen differently", "It has no effect on emotions"], "correct": 2, "explanation": "Anger and guilt require the belief that someone could have chosen to act differently. When free will is understood not to exist, the premise these emotions need to sustain themselves dissolves."}]
  },
  {
    ...
    questions: [{"q": "What do many people incorrectly expect after beliefs change?", "options": ["That life will improve immediately", "That the old thought will never arise again", "That they will feel happy all the time", "That other people will treat them better"], "correct": 1, "explanation": "Many people expect that once a belief changes, the old thought will no longer arise. When old thoughts keep surfacing, they conclude the work has failed \u2014 but this is a misunderstanding of how the brain works."}, {"q": "When a belief changes, what happens to old neurons?", "options": ["They disappear", "They are replaced by new ones", "They remain \u2014 old thoughts will still surface", "They become inactive permanently"], "correct": 2, "explanation": "When beliefs change, new neurons form alongside the existing ones. The old neurons do not disappear. Old thoughts will still surface in conscious awareness. This is normal."}, {"q": "What is the correct practice when an old thought arises?", "options": ["Suppress it as quickly as possible", "Distract yourself from it", "Apply the new, accurate understanding to meet it", "Accept that the belief hasn't changed"], "correct": 2, "explanation": "The practice is applying accurate understanding when old thoughts arise \u2014 not preventing old thoughts. Every time this happens, the new neuronal pathway strengthens."}, {"q": "How do beliefs actually change?", "options": ["Through willpower and positive thinking", "By choosing to think differently", "When new data provides sufficient reasoning to alter the existing understanding", "Through relaxation and meditation"], "correct": 2, "explanation": "Beliefs change when new data provides sufficient reasoning to alter the existing understanding. Not through effort or willpower \u2014 through the receipt of accurate information."}]
  },
  {
    ...
    questions: [{"q": "What is a person"s value, accurately understood?", "options": ["Their value to their own success", "The role they play in other people"s development", "Their achievements and contributions", "Their potential"], "correct": 1, "explanation": "A person"s value is never their value to their own development. It is the role they play in other people"s development — the data they contribute to the system of life."}, {"q": "Is a person"s worth affected by whether they believe they are worthy?", "options": ["Yes — if you don"t believe in your worth, it diminishes", "Yes — worth depends on self-belief", "No — worth is structural and exists regardless of what anyone believes", "It depends on the person"], "correct": 2, "explanation": "A person is valuable regardless of whether they believe they are valuable. The belief and the fact are two separate things. The earth does not become flat because someone believes it is."}, {"q": "What does the earth image demonstrate?", "options": ["That the world is beautiful", "That every person on earth is meant to be here and has purpose", "That some people matter more than others", "That life is complex"], "correct": 1, "explanation": "Imagining a picture of the earth with every person visible — you cannot circle one person who is not meant to be there. If they are on this earth, they are meant to be here. Their presence is structural, not accidental."}, {"q": "What does the feeling of worthiness follow?", "options": ["Achieving important goals", "Other people"s approval", "The accurate understanding — feeling follows understanding, not the other way around", "Years of therapy"], "correct": 2, "explanation": "The feeling of worthiness follows the accurate understanding — it does not precede it. The understanding comes first. The feeling follows."}]
  },
  {
    ...
    questions: [{"q": "What is suicide actually an attempt to do?", "options": ["End existence permanently", "Escape the pressure being placed on perceived value", "Punish others", "Give up on life"], "correct": 1, "explanation": "Suicide is not an attempt to end existence. It is an attempt to escape the pressure being placed on perceived value — to find a place where the pressure stops."}, {"q": "What does a person who considers suicide actually want?", "options": ["To die", "The belief that their value is under permanent threat to end", "To hurt others", "To be rescued"], "correct": 1, "explanation": "The person does not want to die. They want the belief that their value is under permanent threat to end. They are trying to escape the pressure, not existence itself."}, {"q": "What is connected to suicidal thinking?", "options": ["Weakness of character", "The Achievement Model"s conclusion that worth can no longer be proven", "Mental illness only", "Difficult childhood"], "correct": 1, "explanation": "Suicidal thinking is connected to the Achievement Model. When a person concludes that the particular achievement that would prove their worth is no longer attainable, life feels unbearable."}, {"q": "What does the accurate understanding do that prevents suicidal thinking?", "options": ["It provides hope for the future", "It replaces the belief that value is attached to any outcome with the accurate account that worth is unconditional", "It teaches coping strategies", "It improves circumstances"], "correct": 1, "explanation": "Every person who understands that their value is the automatic role they play in the system of life survives situations that would otherwise produce suicidal thinking — not because circumstances are better, but because the belief producing the pressure has been replaced."}]
  },
  {
    ...
    questions: [{"q": "What does the "You Knew" camp believe?", "options": ["People are always doing their best", "People have free will and could have chosen differently — failure is a moral category", "People need better circumstances", "People grow through experience"], "correct": 1, "explanation": "The "You Knew" camp holds that people have free will and are either choosing correctly or not. Failure is seen as a moral category — the result of not choosing to do better."}, {"q": "What does the "You Are Here Learning" camp believe?", "options": ["People have all the answers within them", "Everyone could do better if they tried", "Free will doesn"t exist — people can only respond from their current belief system", "Life is random and unpredictable"], "correct": 2, "explanation": "The "You Are Here Learning" camp holds that decision-making as conventionally understood doesn"t exist — every response is governed by beliefs. People could not have acted differently given their beliefs."}, {"q": "As people grow in understanding, which direction do they move?", "options": ["From "You Are Here Learning" to "You Knew"", "They stay in one camp their whole life", "From "You Knew" to "You Are Here Learning"", "Between camps depending on the situation"], "correct": 2, "explanation": "As people grow in understanding, they move from the "You Knew" camp into the "You Are Here Learning" camp — understanding that everyone is at their current level of development, not choosing to fail."}, {"q": "What does the "You Are Here Learning" camp say about evil?", "options": ["Evil exists and must be punished", "There is no evil — only people at their current level of development requiring further understanding", "Evil is rare but real", "Evil is a social construct"], "correct": 1, "explanation": "The "You Are Here Learning" camp holds that there is no evil — only people at their current level of development, requiring further assistance in understanding life."}]
  },
  {
...
export default function App() {
  ...
  const renderLessonQuiz = (lesson, lessonIdx) => {
    ...
    const q = lesson.questions[quizQuestionIdx];
    const progress = (quizQuestionIdx / lesson.questions.length) * 100;
    return (
      <div style={styles.section}>
        ...
        <div style={{ fontSize: 12, color: "rgba(150,180,230,0.5)", marginBottom: 16 }}>Question {quizQuestionIdx + 1} of {lesson.questions.length}</div>
        <div style={{ ...styles.card, marginBottom: 16 }}>
        ...
        <button disabled={quizSelected === null} onClick={() => {
          ...
          if (quizQuestionIdx + 1 >= lesson.questions.length) {
            setQuizComplete(true);
            if (isCorrect || newAnswers.filter(a => a.correct).length >= Math.ceil(lesson.questions.length * 0.75)) {
          ...
          {quizQuestionIdx + 1 >= lesson.questions.length ? "Submit →" : "Next →"}
        </button>
      </div>
    );
  };
        ...
        <div style={styles.section}>
          ...
          {lesson.questions && lesson.questions.length > 0 && (
            <div style={{ ...styles.card, borderColor: "rgba(106,163,232,0.3)", background: "rgba(106,163,232,0.06)", marginBottom: 14 }}>
              ...
              <p style={{ ...styles.p, fontSize: 13, marginBottom: 12 }}>{lesson.questions.length} questions to check your grasp of this lesson.</p>
              ...
              <button key={i} onClick={() => { setActiveLesson(realIdx); setLessonQuizActive(false); }} style={{ ...styles.card, cursor: "pointer", textAlign: "left", display: "flex", alignItems: "center", gap: 14, marginBottom: 0, width: "100%", borderColor: isDone ? "rgba(80,200,120,0.3)" : "rgba(106,163,232,0.15)" }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                    ...
                    {item.questions && <span style={{ fontSize: 10, color: "rgba(106,163,232,0.5)" }}>· {item.questions.length}Q</span>}
                  </div>
                </div>
